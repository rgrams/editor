...
local function new(basePath, btnText)
	local self = mod(Panel(0, 0, 0, 700, 500, 0, 0, 0, 0, "fit", nil, 16), {name = "FileDialog", layer = "popupPanels", script = {dialogScript}, children = {
		mod(gui.Column(6, nil, {{1},{2},{3,nil,true},{4}}, 0, 0, 0, 670, 400, 0, -1, 0, -1, {"stretch", "fit"}), {children = {
			...
			mod(gui.Mask(), {resizeModeX = "fill", resizeModeY = "fill", isPopup = true, script = {filesPanelScript}, children = {
